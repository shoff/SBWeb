namespace SB.Domain.Models
{
    ...
    public class Interactive : AnimationObject
    {
        ...
        public override void Parse(byte[] data)
        {
            ...
            try
            {
                ...
                */
                    ...
                    for (uint i = 0; i < counter; i++)
                    {
                        ...
                        {
                            logger.LogError(e4, "Exception thrown parsing CacheIndex {0}, in Interactive exception e4.",
                                this.CacheIndex.Identity);
                            break;
                        }
                    }
            ...
            {
                logger.LogError(e5, "Exception thrown parsing CacheIndex {0}, in Interactive exception e5.",
                    this.CacheIndex.Identity);
            }
        }
    }
