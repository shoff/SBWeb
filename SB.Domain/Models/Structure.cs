namespace SB.Domain.Models
{
    ...
    public class Structure : ModelObject
    {
        ...
        private readonly List<Renderable> renderEntities = new List<Renderable>();
        ...
        public Structure(ILogger<ModelObject> logger, CacheIndex cacheIndex, ObjectType flag, 
            string name, int offset, byte[] data, int innerOffset)
        ...
        public override void Parse(byte[] data)
        {
            ...
            try
            {
                ...
                */
                ...
                for (uint i = 0; i < this.counter; i++)
                {
                    ...
                    {
                        logger.LogError(e5, "Error parsing structure for CacheIndex {0} in Structure line 309.",
                            this.CacheIndex.Identity);
                        break;
                    }
                }
            ...
            {
                logger.LogError(e6, "Error parsing structure for CacheIndex {0} in Structure line 317.",
                    this.CacheIndex.Identity);
        ...
        public void Parsssse(byte[] data)
        {
            using (var reader = data.CreateBinaryReaderUtf32())
            {
                ...
                */
                ...
                {
                    throw new ArgumentOutOfRangeException("The number of meshes exceeded 5000");
                }
